...
>[NNS协议规范](protocol.md)
>
>[顶级域名合约详解](contract_nns.md)
>
>[所有者合约详解](contract_owner.md)
>
>[注册器合约详解](contract_register.md)
>
>[解析器合约详解](contract_resolver.md)
>
# NNS 是什么
...
## 顶级域名合约
域名根是一个根域名 比如.test 所有信息的管理者。
无论二级域名   aa.test 还是 三级域名 bbb.aa.test,他们的所有者都保存在域名根之中。
域名根以字典的形式保存如下数据
1.  域名的所有者(owner)
2.  域名的注册器(register)
3.  域名的解析器(resolver)
